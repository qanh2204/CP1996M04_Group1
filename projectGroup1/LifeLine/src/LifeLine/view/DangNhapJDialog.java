...
public class DangNhapJDialog extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        jpnRoot.add(jPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 200, 340, 280));

        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/LifeLine/Images/hinh-nen-la-cay-tuoi-xanh-11.jpg"))); // NOI18N
        jpnRoot.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, -30, 1110, 670));
    ...
    private void btnSubmitActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSubmitActionPerformed
        ...
        String type = userService.getType(user, pass);
        ...
        if (user.length() == 0 || pass.length() == 0) {
            ...
            this.dispose();
            lifeLine.view.ListUserFrame userFrame = new lifeLine.view.ListUserFrame();
            userFrame.setTitle("Adim Form");
